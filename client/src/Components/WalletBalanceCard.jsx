...
const WalletBalanceCard = () => {
  ...
  const handleDepositClick = () => {
    // You can set a default amount or get it from user input
    setDepositAmount(0);
        ...
        <div className="relative z-10">
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-1.5 p-2.5 rounded-xl bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white font-semibold transition-all duration-300 shadow-lg shadow-green-500/25 group text-sm"
            >
              <ArrowUpRight
                size={14}
