...
import { formatCurrency, fmtNum, formatDate } from "../../Components/formatHelpers";
import { getPlatform, getStatus } from "../../Components/socialOrderHelpers";
...
const BoostingHistory = () => {
  ...
  const activeCount = orders.data.filter(
  ...
  const filtered = orders.data
    .filter((o) => {
      ...
      return (
        matchSearch && (filterStatus === "all" || o.status === filterStatus)
      );
    })
    .sort((a, b) => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">
              Track the status of all your boosting orders
            </p>
          </div>
          <button
          ...
          >
            <RefreshCw
              className={`w-4 h-4 ${orders.refreshing ? "animate-spin" : ""}`}
            />
        ...
        >
          ...
          >
            ...
            <option value="partial" className="bg-gray-900">
              Partial
            </option>
                        ...
                        >
                          <td className="px-4 py-3">
                            <div className="flex items-center gap-3">
                              <div
                                className={`p-2 rounded-lg ${platform.bg} border ${platform.border} flex-shrink-0`}
                              >
                                <PlatformIcon
                          ...
                          <td className="px-4 py-3 hidden sm:table-cell">
                            <p className="text-white text-sm">
                              {fmtNum(order.quantity)}
                            </p>
                            {order.remains != null && (
                              <p className="text-gray-500 text-xs">
                                {fmtNum(order.remains)} left
                              </p>
                            )}
                          </td>
                          <td className="px-4 py-3">
